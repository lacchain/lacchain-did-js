...
export function getVerificationMethod( did, index, algo, encoding, value, controller ) {
...
export function wrapDidDocument( did, id, controller, history, mode ) {
...
export function getResolver( config = {} ) {
	...
	async function resolve( did ) {
		...
		const registry = new ethers.Contract( network.registry, DIDRegistryContract.abi, provider )
